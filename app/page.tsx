...
export default function Home() {
  ...
  return (
      <div
          ...
          style={{ backgroundImage: "url('/dogsbackground.webp')", backgroundSize: "contain" }}
      >
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl font-bold text-black mb-8 max-w-2xl mx-auto">
            Професионални услуги за нега на вашето крзнено пријателче.
          </p>
      ...
      <section id="services" className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Капење со соодветен шампон според типот на крзно, темелно четкање за отстранување на мртви влакна и јазли и сушење за чист и негуван изглед.
          ...
          <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-shadow">
            <div className="text-5xl mb-4">🐾</div>
            <h4 className="text-2xl font-bold text-gray-900 mb-3">Нега на нокти и шепи</h4>
            <p className="text-gray-600">
              Скратување и обликување на ноктите, проверка и основна нега на шепите за поголема удобност и безбедно движење.
